  ...
  installBtn.addEventListener("click", async () => {
    if (!deferredPrompt) {
      ...
      if (/iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream) {
        ...
        alert("Встановлення недоступне зараз. Спробуйте оновити сторінку або використати інший браузер.")
      }
      return
    }
    ...
    try {
      ...
      alert("Виникла помилка під час встановлення. Спробуйте ще раз або використайте інший браузер.")
    }
  })
}
